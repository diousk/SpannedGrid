...
public class SpannedGridLayoutManager2 extends RecyclerView.LayoutManager {
    ...
    public SpannedGridLayoutManager2(
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.SpannedGridLayoutManager2, defStyleAttr, defStyleRes);
        columns = a.getInt(R.styleable.SpannedGridLayoutManager2_spanCount, 1);
        parseAspectRatio(a.getString(R.styleable.SpannedGridLayoutManager2_aspectRatio));
        // TODO use this!
        int orientation = a.getInt(
                R.styleable.SpannedGridLayoutManager2_android_orientation, RecyclerView.VERTICAL);
        a.recycle();
    }
